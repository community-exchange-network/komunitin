...
- `workflows/backup-test.yml` restores the published `komunitin/komunitin-db` image for accounting and notifications databases. Keep it in sync with `shared/docker/db/AGENTS.md`.
