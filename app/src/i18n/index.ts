...
if (import.meta.env.FEAT_TOPUP === 'true') {
  langs["en-us"].features = {
    topup: async () => (await import("@/i18n/en-us/topup.json")).default as never
  }
  langs["ca"].features = {
    topup: async () => (await import("@/i18n/ca/topup.json")).default as never
  }
  langs["es"].features = {
    topup: async () => (await import("@/i18n/es/topup.json")).default as never
  }
  langs["fr"].features = {
    topup: async () => (await import("@/i18n/fr/topup.json")).default as never
  }
}
