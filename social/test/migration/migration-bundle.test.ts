...
test('preserves compatible password hashes and rejects unsupported credentials without echoing them', async (t) => {
  ...
  const cases = [
    ...
    ['Drupal SHA-512', '$S$D' + 'a'.repeat(51), true],
    ['Drupal phpass', '$P$B' + 'a'.repeat(30), false],
    ['Drupal phpBB', '$H$B' + 'a'.repeat(30), false],
    ['Drupal upgraded MD5', 'U$S$D' + 'a'.repeat(51), false],
    ['Drupal upgraded phpass', 'U$P$B' + 'a'.repeat(30), false],
    ['Drupal invalid cost', '$S$4' + 'a'.repeat(51), false],
    ['Drupal excessive cost', '$S$T' + 'a'.repeat(51), false],
    ['Drupal truncated', '$S$D' + 'a'.repeat(50), false],
    ['Drupal invalid alphabet', '$S$D' + 'a'.repeat(50) + '!', false],
